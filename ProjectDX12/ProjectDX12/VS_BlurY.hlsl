...
VS_OUT main(VS_IN input)
{
    ...
    output.tex2.xy = float2(0.0f, 3.0f / height);
    output.tex3.xy = float2(0.0f, 4.0f / height);
    output.tex4.xy = float2(0.0f, 5.0f / height);
    output.tex5.xy = float2(0.0f, 6.0f / height);
    output.tex6.xy = float2(0.0f, 7.0f / height);
    output.tex7.xy = float2(0.0f, 8.0f / height);
	// 反対方向にテクセルをずらした座標を格納
